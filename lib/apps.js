...
// Coming-soon placeholders (POS, Orders, Books, Payroll, Inventory,
// Vendors, CRM, Support, Sites as standalone apps) removed — none of them
// are real, working products, and Bizzux Shop already covers POS/
// Inventory/Vendors as tabs of the one real app. Only apps that actually
// exist and work stay listed here.
export const APP_CATALOG = [
  {
    key: "juicechatjunction", name: "Bizzux Business", icon: "🏪",
    features: [
  ...
  { key: "notes", name: "Bizzux Notes", icon: "📝" },
  { key: "files", name: "Bizzux Files", icon: "🗂️" },
  { key: "projects", name: "Bizzux Projects", icon: "🗒️" },
];
