...
// Base annual price before any annual-specific discount — always 12x the
// monthly price, per the admin's own framing ("if monthly is 1000, yearly
// should be 12000 before any discount").
export function annualBasePrice(monthlyPrice) {
  return Number(monthlyPrice) * 12;
}
