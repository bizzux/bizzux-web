// Dial codes for the sign-up phone field's country dropdown, plus a
// national mobile-number length to validate against once a country is
// picked. `len` is either an exact digit count (most countries have a
// fixed mobile number length) or a [min, max] range for countries whose
// mobile numbers vary. Countries without a confidently-known exact length
// fall back to GENERIC_LEN, a permissive range that comfortably covers
// real-world mobile numbers without being incorrectly strict.
const GENERIC_LEN = [6, 12];
...
const RAW_COUNTRIES = [
  ...
  { iso2: "AR", name: "Argentina", dial: "+54", len: [10, 11] },
  { iso2: "AM", name: "Armenia", dial: "+374" },
  { iso2: "AW", name: "Aruba", dial: "+297" },
  { iso2: "AU", name: "Australia", dial: "+61", len: 9 },
  { iso2: "AT", name: "Austria", dial: "+43", len: [10, 11] },
  { iso2: "AZ", name: "Azerbaijan", dial: "+994" },
  { iso2: "BS", name: "Bahamas", dial: "+1242" },
  { iso2: "BH", name: "Bahrain", dial: "+973", len: 8 },
  { iso2: "BD", name: "Bangladesh", dial: "+880", len: 10 },
  { iso2: "BB", name: "Barbados", dial: "+1246" },
  { iso2: "BY", name: "Belarus", dial: "+375" },
  { iso2: "BE", name: "Belgium", dial: "+32", len: 9 },
  ...
  { iso2: "BR", name: "Brazil", dial: "+55", len: 11 },
  ...
  { iso2: "CA", name: "Canada", dial: "+1", len: 10 },
  ...
  { iso2: "CL", name: "Chile", dial: "+56", len: 9 },
  { iso2: "CN", name: "China", dial: "+86", len: 11 },
  { iso2: "CO", name: "Colombia", dial: "+57", len: 10 },
  ...
  { iso2: "DK", name: "Denmark", dial: "+45", len: 8 },
  ...
  { iso2: "EG", name: "Egypt", dial: "+20", len: 10 },
  ...
  { iso2: "FI", name: "Finland", dial: "+358", len: [6, 10] },
  { iso2: "FR", name: "France", dial: "+33", len: 9 },
  ...
  { iso2: "DE", name: "Germany", dial: "+49", len: [10, 11] },
  { iso2: "GH", name: "Ghana", dial: "+233" },
  { iso2: "GI", name: "Gibraltar", dial: "+350" },
  { iso2: "GR", name: "Greece", dial: "+30", len: 10 },
  ...
  { iso2: "HK", name: "Hong Kong", dial: "+852", len: 8 },
  { iso2: "HU", name: "Hungary", dial: "+36" },
  { iso2: "IS", name: "Iceland", dial: "+354" },
  { iso2: "IN", name: "India", dial: "+91", len: 10 },
  { iso2: "ID", name: "Indonesia", dial: "+62", len: [9, 12] },
  { iso2: "IR", name: "Iran", dial: "+98", len: 10 },
  { iso2: "IQ", name: "Iraq", dial: "+964", len: 10 },
  { iso2: "IE", name: "Ireland", dial: "+353", len: 9 },
  { iso2: "IL", name: "Israel", dial: "+972", len: 9 },
  { iso2: "IT", name: "Italy", dial: "+39", len: [9, 10] },
  { iso2: "JM", name: "Jamaica", dial: "+1876" },
  { iso2: "JP", name: "Japan", dial: "+81", len: 10 },
  { iso2: "JO", name: "Jordan", dial: "+962", len: 9 },
  { iso2: "KZ", name: "Kazakhstan", dial: "+7" },
  { iso2: "KE", name: "Kenya", dial: "+254", len: 9 },
  { iso2: "KI", name: "Kiribati", dial: "+686" },
  { iso2: "KP", name: "North Korea", dial: "+850" },
  { iso2: "KR", name: "South Korea", dial: "+82", len: [9, 10] },
  { iso2: "KW", name: "Kuwait", dial: "+965", len: 8 },
  { iso2: "KG", name: "Kyrgyzstan", dial: "+996" },
  { iso2: "LA", name: "Laos", dial: "+856" },
  { iso2: "LV", name: "Latvia", dial: "+371" },
  { iso2: "LB", name: "Lebanon", dial: "+961", len: [7, 8] },
  ...
  { iso2: "MY", name: "Malaysia", dial: "+60", len: [9, 10] },
  ...
  { iso2: "MX", name: "Mexico", dial: "+52", len: 10 },
  ...
  { iso2: "NP", name: "Nepal", dial: "+977", len: 10 },
  { iso2: "NL", name: "Netherlands", dial: "+31", len: 9 },
  { iso2: "NC", name: "New Caledonia", dial: "+687" },
  { iso2: "NZ", name: "New Zealand", dial: "+64", len: [8, 9] },
  { iso2: "NI", name: "Nicaragua", dial: "+505" },
  { iso2: "NE", name: "Niger", dial: "+227" },
  { iso2: "NG", name: "Nigeria", dial: "+234", len: 10 },
  { iso2: "NU", name: "Niue", dial: "+683" },
  { iso2: "MK", name: "North Macedonia", dial: "+389" },
  { iso2: "NO", name: "Norway", dial: "+47", len: 8 },
  { iso2: "OM", name: "Oman", dial: "+968", len: 8 },
  { iso2: "PK", name: "Pakistan", dial: "+92", len: 10 },
  ...
  { iso2: "PE", name: "Peru", dial: "+51", len: 9 },
  { iso2: "PH", name: "Philippines", dial: "+63", len: 10 },
  { iso2: "PL", name: "Poland", dial: "+48", len: 9 },
  { iso2: "PT", name: "Portugal", dial: "+351", len: 9 },
  { iso2: "PR", name: "Puerto Rico", dial: "+1787" },
  { iso2: "QA", name: "Qatar", dial: "+974", len: 8 },
  { iso2: "RE", name: "Reunion", dial: "+262" },
  { iso2: "RO", name: "Romania", dial: "+40" },
  { iso2: "RU", name: "Russia", dial: "+7", len: 10 },
  ...
  { iso2: "SA", name: "Saudi Arabia", dial: "+966", len: 9 },
  ...
  { iso2: "SG", name: "Singapore", dial: "+65", len: 8 },
  ...
  { iso2: "ZA", name: "South Africa", dial: "+27", len: 9 },
  { iso2: "SS", name: "South Sudan", dial: "+211" },
  { iso2: "ES", name: "Spain", dial: "+34", len: 9 },
  { iso2: "LK", name: "Sri Lanka", dial: "+94", len: 9 },
  { iso2: "SD", name: "Sudan", dial: "+249" },
  { iso2: "SR", name: "Suriname", dial: "+597" },
  { iso2: "SE", name: "Sweden", dial: "+46", len: [7, 9] },
  { iso2: "CH", name: "Switzerland", dial: "+41", len: 9 },
  { iso2: "SY", name: "Syria", dial: "+963" },
  { iso2: "TW", name: "Taiwan", dial: "+886", len: 9 },
  { iso2: "TJ", name: "Tajikistan", dial: "+992" },
  { iso2: "TZ", name: "Tanzania", dial: "+255" },
  { iso2: "TH", name: "Thailand", dial: "+66", len: 9 },
  ...
  { iso2: "TR", name: "Turkey", dial: "+90", len: 10 },
  ...
  { iso2: "AE", name: "United Arab Emirates", dial: "+971", len: 9 },
  { iso2: "GB", name: "United Kingdom", dial: "+44", len: 10 },
  { iso2: "US", name: "United States", dial: "+1", len: 10 },
  ...
  { iso2: "VN", name: "Vietnam", dial: "+84", len: [9, 10] },
...
export const COUNTRIES = RAW_COUNTRIES.map((c) => ({ ...c, len: c.len ?? GENERIC_LEN })).sort((a, b) =>
...
export function findCountry(iso2) {
  return COUNTRIES.find((c) => c.iso2 === iso2) || COUNTRIES.find((c) => c.iso2 === DEFAULT_COUNTRY_ISO2);
}

// A single accurate label, e.g. "10 digits" or "9-10 digits", used in the
// validation error message where there's room for the full word.
export function phoneLengthLabel(len) {
  return Array.isArray(len) ? `${len[0]}-${len[1]} digits` : `${len} digits`;
}

// A shorter variant ("10 digit", "9-10 digit") for the field's placeholder,
// which has much less room — the full "Phone number (10 digits)" wording
// was getting clipped inside the input.
export function phoneLengthShortLabel(len) {
  return Array.isArray(len) ? `${len[0]}-${len[1]} digit` : `${len} digit`;
}

export function isValidPhoneLength(digits, len) {
  const n = digits.length;
  return Array.isArray(len) ? n >= len[0] && n <= len[1] : n === len;
}

// Reverse lookup for a stored full phone number (e.g. "+919591222822",
// saved with its dial code by the sign-up form) back to a country name —
// used by the Super Admin Customers list. Matches the LONGEST dial code
// that's a prefix of the number, since dial codes vary from 1 to 4 digits
// and a short one (e.g. "+1") can otherwise wrongly match numbers that
// actually belong to a longer code sharing the same start (e.g. "+1264").
export function findCountryByPhone(phone) {
